...
```javascript
import t from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-t@v0.2.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { T, cdf, entropy, kurtosis, logcdf, logpdf, mean, median, mode, pdf, quantile, skewness, stdev, variance } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-t@v0.2.0-deno/mod.js';
```
